...
We estimated simplex regression models with parametric mean link functions `plogit1` and `plogit2`, incorporating all eight covariates, selected powers of regressors, and interaction terms.

Predictor selection was guided by half-normal residual plots with simulated envelopes, pseudo-\(R^2\), and information criteria (AIC, SIC, HQIC).
...
```{r link-comparison, fig.cap="Plogit1 and probit link functions used in the simplex and beta regression models"}
