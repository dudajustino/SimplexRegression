...
cat("Mean:     ", round(mean(data_imp$Impunity), 4), "\n")
cat("Median:   ", round(median(data_imp$Impunity), 4), "\n")
cat("Std Dev:  ", round(sd(data_imp$Impunity), 4), "\n")
cat("Variance: ", round(var(data_imp$Impunity), 4), "\n")
cat("Min:      ", round(min(data_imp$Impunity), 4), "\n")
cat("Max:      ", round(max(data_imp$Impunity), 4), "\n")
